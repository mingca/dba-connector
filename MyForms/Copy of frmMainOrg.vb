...
#Region "Testing"
    ...
    'force end edit
    Private Sub btnTest2_Click(sender As System.Object, e As System.EventArgs)
        mainBSrce.EndEdit()
    End Sub
    ...
    Private Sub GetCountry(ByVal usrCountry As String)
        ...
        Else
            ...
            If reslt = String.Empty Then
                ...
                SendEmail.SendHTMLEmail(DBAdmin.StaffEmail, "unknown country: " & usrCountry, usr & " OrgID: " & ThisID.ToString) '"App: InfoCtr&#xaConnection String:\n" & sc.ConnectionString.ToString & "&#x0aComputer Name: " & IsNull(Environ("ComputerName"), "na") & "%OD%OAError: " & exc.Message)
                SendEmail = Nothing
...
#Region "General"
    ...
    'STOP BLINKING
    Private Sub flagWarning_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
