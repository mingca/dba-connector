...
SPECIALMAILFLAG:
        ...
        If Me.cboPrintFlag.SelectedIndex > -1 Then
            ...
            strSQL.Parameters.Add("@MailFlag", SqlDbType.Text)
            strSQL.Parameters("@MailFlag").Value = Me.cboPrintFlag.Text
...
BranchBetweenMailEmail:
        ...
        Else 'rbEmail.checked = true
            ' GoTo EmailForm
            OpenEmailForm(strSQL, "SEND EMAIL")
            GoTo CloseAll
        End If
